...
quentin_df = pd.read_csv(
    "/home/julio/Documents/data-annotation/Image-Data-Annotation/scripts/quentin_measurement_file.csv"
)
georges_df = pd.read_csv(
    "/home/julio/Documents/data-annotation/Image-Data-Annotation/assays/CTCF-AID/analysis_df.csv"
)
...
merged_df["Principal_axis_diff"] = (
    merged_df["A565_principal_axis"] - merged_df["volume"]
)
